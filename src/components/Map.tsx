...
// Default fallback token - in production, this should be your actual public token
const DEFAULT_MAPBOX_TOKEN = "pk.eyJ1IjoiZGVmYXVsdCIsImEiOiJjbHMxMjM0NTYifQ.example_token";
